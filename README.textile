...
*Important note:* Only users with the permission _TICKET_ADD_HOURS_ can use the features of the TracHoursPlugin and Trac2mite. The following steps assume you have this permission.
